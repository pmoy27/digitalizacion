...
<div id="crud-modal" tabindex="-1" aria-hidden="true" class="hidden overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 justify-center items-center w-full md:inset-0 h-[calc(100%-1rem)] max-h-full">
    <div class="relative p-4 w-full max-w-md max-h-full">
        ...
        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
            ...
            <form class="p-4 md:p-5" action="{{route('folder.AgregarFolder')}}" method="post" enctype="multipart/form-data">
                @csrf
...
<div class="container  mx-auto flex ">
    @foreach ($folders as $carpeta)
    <a href="folder/{{$carpeta->id}}" class="transition w-96 h-32 bg-white shadow rounded-lg overflow-hidden m-4 hover:-translate-y-1 hover:scale-110 duration-300">
        <div class="px-4 py-2">
